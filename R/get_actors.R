#' This function returns the actors of Movies and TV shows based on search word(s) by user.
#'
...
#'     Dataframe contains Title, Type, Year, and Actors.
#' @export
#'
#' @examples 
...
get_actors <- function(search_text, type = ""){
    ...
    # loop through each search result from JSON to get necessary details like actors
    imdb_id_details <- NA    
