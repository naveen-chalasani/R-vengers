#' This function returns the awards received by Movies and TV shows based on search word(s) by user.
#'
...
#'     Dataframe contains Title, Type, Year, and Awards.
#' @export
#'
#' @examples 
...
get_awards <- function(search_text = "", type = ""){
    ...
    # loop through each search result from JSON to get necessary details like awards
    imdb_id_details <- NA    
