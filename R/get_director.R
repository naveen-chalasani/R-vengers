#' This function returns the director of Movies and TV shows based on search word(s) by user.
#'
...
get_director <- function(search_text, type = ""){
    ...
    # loop through each search result from JSON to get necessary details like director
    imdb_id_details <- NA    
